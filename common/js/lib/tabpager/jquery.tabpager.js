  ...
  e.fn.tabpager = function(a) {
    function t(t) {
      var s = e("." + r.contents + ".current").children().length,
        ...
        o = '<ul id="jquery-tab-pager-navi">\t<li class="pre"><a href="#" class="previos">' + r.previous + "</a></li>";
      for (i = 0; i < l; i++) o += '\t<li><a href="#">' + (i + 1) + "</a></li>";
      o += '\t<li class="nex"><a href="#" class="next">' + r.next + "</a></li></ul>";
      var c = t;
      0 == t ? (c = parseInt(e("#jquery-tab-pager-navi li a.current").html())) - 1 != 0 && c-- : t == l + 1 && (c = parseInt(e("#jquery-tab-pager-navi li a.current").html())) + 1 != l + 1 && c++, t = c, 0 == s && (o = ""), e("#jquery-tab-pager-navi").remove(), "top" == r.position ? e("." + r.contents + ".current").before(o) : e("." + r.contents + ".current").after(o), e("#jquery-tab-pager-navi li a").removeClass("current"), e("#jquery-tab-pager-navi li a").eq(t).addClass("current"), e("#jquery-tab-pager-navi li a").removeClass("disable"), c = parseInt(e("#jquery-tab-pager-navi li a.current").html()), c - 1 == 0 && e("#jquery-tab-pager-navi li a.previos").addClass("disable"),c - 1 == 0 && e("#jquery-tab-pager-navi li.pre").addClass("disable"), c == l && e("#jquery-tab-pager-navi li a.next").addClass("disable"), c == l && e("#jquery-tab-pager-navi li.nex").addClass("disable");
      var u = a.items * (t - 1),
        d = a.items * t;
